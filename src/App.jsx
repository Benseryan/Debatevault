    ...
    const html = `
      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .print-bar { display: flex; align-items: center; gap: 16px; background: #f0f0fa; border: 1px solid #ddddf0; border-radius: 10px; padding: 12px 18px; margin-bottom: 24px; }
          .print-bar button { padding: 8px 20px; background: #7864ff; color: #fff; border: none; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; font-family: inherit; }
          .print-bar button:hover { background: #6050ee; }
      ...
      <body>
        <div class="print-bar">
          ...
          <span>Tip: choose "Save as PDF" in the print dialog to save a file</span>
        </div>
        <div class="header">
          <div>
